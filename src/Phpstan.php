...
class Phpstan
{
    ...
    public function analyze(
        ...
        $cmd = array_merge(['phpstan', 'analyse'], $options->buildCliCommand(), ["/tmp/app/$pathToTest"]);
    ...
    #[DaggerFunction]
    public function makeOptions(): PhpstanOptions
    {
        return new PhpstanOptions();
    }
